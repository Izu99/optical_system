  ...
  ThemeData get lightTheme => ThemeData(
    ...
    extensions: <ThemeExtension<dynamic>>[
      ...
      AppPageTheme(
        ...
        tableHeaderBg: const Color(0xFF2563EB).withOpacity(0.08),
        tableEvenRowBg: const Color(0xFFFFFFFF),
        tableOddRowBg: const Color(0xFFF6F8FA),
        paginationBg: const Color(0xFFFFFBFF).withOpacity(0.5),
      ),
    ],
  );
  ...
  ThemeData get darkTheme => ThemeData(
    ...
    extensions: <ThemeExtension<dynamic>>[
      ...
      AppPageTheme(
        ...
        tableHeaderBg: const Color(0xFF4F83FF).withOpacity(0.08),
        tableEvenRowBg: const Color(0xFF1A1D23),
        tableOddRowBg: const Color(0xFF23272F),
        paginationBg: const Color(0xFF1A1D23).withOpacity(0.5),
      ),
    ],
  );
}